...
namespace math
{
    ...
    FrustumCorners GetFrustumCornersWCS(const glm::float4x4& view, const glm::float4x4& proj, glm::float3* pOutCenter = nullptr);
    FrustumCorners GetFrustumCornersWCS(const glm::float4x4& viewProj, glm::float3* pOutCenter = nullptr);
    FrustumCorners GetFrustumCornersWCS_Inv(const glm::float4x4& invViewProj, glm::float3* pOutCenter = nullptr);
}
