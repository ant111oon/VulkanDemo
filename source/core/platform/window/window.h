...
namespace eng
{
    ...
    public:
        ...
        bool IsCreated() const noexcept { return m_state.test(WND_STATE_IS_CREATED); }
    ...
    protected:
        ...
        void SetCreatedState(bool initialized) noexcept { m_state.set(WND_STATE_IS_CREATED, initialized); }
