...
namespace eng
{
    ...
    static WndKey win32VirtualKeyToWndKey(WORD vk) noexcept
    {
        switch (vk) {
            ...
            case VK_LWIN: return WndKey::KEY_LEFT_WIN;
            case VK_RWIN: return WndKey::KEY_RIGHT_WIN;
            default:
    ...
    LRESULT Win32Window::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        switch (uMsg) {
            ...
            case WM_MOUSEMOVE:
                return OnMouseCursorEvent(wParam, lParam);
            case WM_MOUSEWHEEL:
            ...
            case WM_LBUTTONDOWN:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::LEFT, WndMouseButtonState::PRESSED);
            case WM_LBUTTONUP:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::LEFT, WndMouseButtonState::RELEASED);
            case WM_LBUTTONDBLCLK:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::LEFT, WndMouseButtonState::DOUBLE_CLICKED);
            case WM_RBUTTONDOWN:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::RIGHT, WndMouseButtonState::PRESSED);
            case WM_RBUTTONUP:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::RIGHT, WndMouseButtonState::RELEASED);
            case WM_RBUTTONDBLCLK:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::RIGHT, WndMouseButtonState::DOUBLE_CLICKED);
            case WM_MBUTTONDOWN:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::MIDDLE, WndMouseButtonState::PRESSED);
            case WM_MBUTTONUP:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::MIDDLE, WndMouseButtonState::RELEASED);
            case WM_MBUTTONDBLCLK:
                return OnMouseEvent<WndMouseButtonEvent>(wParam, lParam, WndMouseButtonType::MIDDLE, WndMouseButtonState::DOUBLE_CLICKED);
            default:
